    ...
    const list = useMemo(() => {
        ...
        return contacts
            ...
            .filter((c) => {
                ...
                return qd.length > 0 && digitsOf(c.number).includes(qd);
            })
        ...
        <div className="wl-sheet" onClick={onClose}>
            <div className="wl-sheet__panel" onClick={(e) => e.stopPropagation()}>
                <div className="wl-sheet__bar">
                    ...
                    <button className="wl-sheet__done" onClick={onClose}>
                        {t('common.done')}
                    </button>
                </div>
                ...
                <div className="wl-sheet__search">
                    ...
                    <input
                        value={q}
                        placeholder={t('wallet.searchRecipient')}
                    ...
                    <div className="wl-sheet__list">
                        {list.map((c) => (
                            <button
                                ...
                                onClick={() =>
                                    onPick({ number: c.number, name: c.name, img: c.img })
                                }
                            >
