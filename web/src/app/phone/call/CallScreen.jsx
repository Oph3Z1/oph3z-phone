...
export default function CallScreen() {
    ...
    if (call.state === 'outgoing')
        status = call.wantsVideo ? t('call.callingVideo') : t('call.calling');
    else if (call.state === 'active') status = fmt(elapsed);
    else if (call.state === 'incoming')
        status = call.wantsVideo ? t('call.incomingVideo') : t('call.incoming');
            ...
            {call.videoReq ? (
                <div className="cs-videoreq">
                    ...
                    <div className="cs-videoreq__btns">
                        <button className="cs-videoreq__decline" onClick={declineVideo}>
                            {t('call.decline')}
                        </button>
                        <button className="cs-videoreq__accept" onClick={acceptVideo}>
                            {t('call.accept')}
                        </button>
                    </div>
                </div>
