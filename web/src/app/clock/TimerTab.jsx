...
function ActiveTimer({ timer }) {
  ...
  // Wall-clock end time (only meaningful while running).
  ...
  return (
    <div className="clk-screen clk-screen--center">
      ...
      <div className="clk-btnrow">
        ...
        {timer.paused ? (
          <button className="clk-rbtn clk-rbtn--green" onClick={() => dispatch(resumeTimer())}>
            {t('clock.resume')}
          </button>
        ) : (
          <button className="clk-rbtn clk-rbtn--amber" onClick={() => dispatch(pauseTimer())}>
            {t('clock.pause')}
          </button>
        )}
      </div>
...
const BellSmall = () => (
  <svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" style={{ verticalAlign: '-0.12em' }}>
      ...
      <div className="clk-scroll clk-scroll--timer">
        ...
        <div className="clk-recents">
          <div className="clk-recents__head">
            ...
            {recents.length > 0 && (
              <button className="clk-recents__edit" onClick={() => setEditing((v) => !v)}>
