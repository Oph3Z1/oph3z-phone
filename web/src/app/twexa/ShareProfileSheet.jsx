        ...
        <div className="x-sheet" onClick={onClose}>
            <div className="x-sheet__panel" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="x-sheet__actions x-sheet__actions--col">
                    <button className="x-sheet__btn x-sheet__btn--row" onClick={doAirdrop}>
                        <ShareIcon size={18} /> {t('x.shareAirdrop')}
                    </button>
                    <button
                        className="x-sheet__btn x-sheet__btn--row"
                        onClick={() => setPicking(true)}
                    >
                        <ShareIcon size={18} /> {t('x.shareMessages')}
                    </button>
                    <button className="x-sheet__btn x-sheet__btn--row" onClick={doCopy}>
                        <LinkIcon size={18} /> {t('x.copyHandle')}
                    </button>
                    <button className="x-sheet__btn" onClick={onClose}>
                        {t('common.cancel')}
                    </button>
                </div>
            </div>
