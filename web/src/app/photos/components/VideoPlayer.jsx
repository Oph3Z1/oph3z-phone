...
// Custom iOS-style video player: tap to play/pause, a scrubber, and time labels.
export default function VideoPlayer({ src, poster }) {
  ...
  // Reset when the source changes (navigating between items).
  useEffect(() => {
    setTime(0);
    setDuration(0);
    setPlaying(true);
  ...
  return (
    <div className="ph-vp">
      ...
      >
        <button className="ph-vp__play" onClick={toggle} aria-label={playing ? 'Pause' : 'Play'}>
