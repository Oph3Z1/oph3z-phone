        ...
        <div className="mailapp mail-detail">
            ...
            <div className="mail-detail__scroll">
                ...
                <div className="mail-detail__meta">
                    <span
                        className="mail-detail__avatar"
                        style={{ background: avatarColor(party, mail.system) }}
                    >
                        {initialOf(party)}
                    </span>
                    <div className="mail-detail__who">
                        ...
                        <button
                            className="mail-detail__sub"
                            onClick={copyAddr}
                            title={t('mail.copyAddress')}
                        >
