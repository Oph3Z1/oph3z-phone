...
// Browser-dev mock so the Phone app is usable via `npm run dev`.
const MOCK = {
  number: '555-0142',
  contacts: [
...
export const toggleFavorite = (id, favorite) => async (dispatch) => {
  dispatch(setFavoriteLocal({ id, favorite })); // optimistic
...
// Helpers + thunks for the block list (returns the updated blocked map).
