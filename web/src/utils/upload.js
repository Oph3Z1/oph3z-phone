// Client-side upload of a captured blob (photo/video/voice) to the configured
// provider. Must be client-side: FiveM's server PerformHttpRequest mangles binary.
// Discord needs files[0] PLUS a payload_json part declaring it (without payload_json
// the request is malformed and Cloudflare/Discord reject it).
